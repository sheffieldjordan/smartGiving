...
const compiledFactory = require('../ethereum/build/GiftFactory.json')
const compiledGift = require('../ethereum/build/SmartGift.json')
...
beforeEach(async () => {
	...
	await factory.methods
		...
		.send({
			from: accounts[1],
			value: 1000000001, // Merchant pays for Recipient's gas costs
			gas: 1000000
		})
